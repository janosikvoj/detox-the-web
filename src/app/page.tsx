          ...
          <div className="container">
            ...
            <div className="grid sm:grid-cols-2 gap-8 mx-auto text-left">
              ...
              <Card>
                ...
                <CardContent>
                  <p>
                    Overengineered sites which use interactive 3D objects,
                    complex animations, shader effects and other custom features
                    like scroll-jacking.
                  </p>
                </CardContent>
                <CardFooter>
          ...
          <div className="container">
            ...
            <div className="max-w-2xl mx-auto text-left">
              <p>
                ...
                the diverse possibilities within web design. While these
                extremes serve as useful points of reference, the reality is
                that most successful websites exist somewhere in between. Few
                businesses can truly benefit from the starkness of pure
                minimalism or the sensory overload of extreme maximalism.
                Nevertheless, the underlying philosophy of &quot;less is
                more&quot; remains relevant, encouraging us to prioritize
                clarity, efficiency, and user experience even when incorporating
